// =============================================================================
// CineGo.Desktop - Helpers/HttpClientHelper.cs
// =============================================================================
...
namespace CineGo.Desktop.Helpers
{
    ...
    public sealed class HttpClientHelper
    {
        ...
        /// Uso: var filme = await http.PostAsync&lt;FilmeResponseDto&gt;("/api/filmes", createDto);
        /// </summary>
            ...
            if (ex is HttpRequestException httpEx)
            {
                    ...
                    msg.Contains("no connection could be made"))
                {
                    ...
                    return $"❌ A API não está em execução.\n\n" +
                           ...
                           $"Verifique se o projeto CineGo.API está rodando no Visual Studio.";
                }
