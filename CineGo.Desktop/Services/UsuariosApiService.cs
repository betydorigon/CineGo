// =============================================================================
// CineGo.Desktop - Services/UsuariosApiService.cs
// =============================================================================
...
namespace CineGo.Desktop.Services
{
    ...
    public class UsuariosApiService
    {
        ...
        {
            return await _http.PutAsync<UsuarioResponseDto>($"/api/usuario/{id}", dto);
        }

        public static implicit operator List<object>(UsuariosApiService v)
        {
